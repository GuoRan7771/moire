...
>
  ...
  <main class="relative z-10 pt-32 pb-32 px-4 max-w-2xl mx-auto space-y-12" data-selected-tag={memoList.selectedTag}>
    {#each memoList.visibleMemos as memo}
      ...
      >
        ...
        <div
                class="max-w-none leading-relaxed text-[var(--text-color)]/90
...
<style>
  ...
  @keyframes glitch-anim {
    ...
    100% { clip: rect(4px, 9999px, 29px, 0); }
  }

  @keyframes glitch-anim2 {
    0% { clip: rect(65px, 9999px, 100px, 0); }
    20% { clip: rect(25px, 9999px, 34px, 0); }
    40% { clip: rect(89px, 9999px, 12px, 0); }
    60% { clip: rect(43px, 9999px, 67px, 0); }
    80% { clip: rect(11px, 9999px, 5px, 0); }
    100% { clip: rect(78px, 9999px, 46px, 0); }
  }
